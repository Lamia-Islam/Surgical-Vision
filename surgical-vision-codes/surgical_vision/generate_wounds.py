...
#  MAIN
# ─────────────────────────────────────────────────────────────────────────────
N_PER_CLASS = 15   # dataset size used for all reported results (n=45 total, 15/class)

if __name__ == "__main__":
    healthy    = [generate_healthy(i)    for i in range(1, N_PER_CLASS + 1)]
    concerning = [generate_concerning(i) for i in range(1, N_PER_CLASS + 1)]
    critical   = [generate_critical(i)   for i in range(1, N_PER_CLASS + 1)]
